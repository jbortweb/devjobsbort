        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                  <h1 class="text-2xl font-bold text-center my-10">Candidatos oferta: {{$vacante->titulo}}</h1>
                    ...
                    <ul class="divide-y divide-gray-200 w-full">
                      ...
                      <li class="p-3 flex items-center">
                        <div class="flex-1">
                          ...
                          <p class="text-sm font-medium text-gray-600">Día de inscripción: <span class="font-normal">{{$candidato->created_at->diffForHumans()}}</span></p>
                        </div>
                        <div>
                          <a 
